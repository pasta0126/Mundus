...
- Add **points of interest**: seed-deterministic icon placements from one
  catalog of 86 icons across six categories (relief & geology, nature &
  wildlife, sea & islands, settlements, monuments & ruins, legends &
  mysteries), settlements growing as clusters of five sizes; icons carry no
  text labels and name themselves on hover. Each category is independently
  toggleable via the layer system.

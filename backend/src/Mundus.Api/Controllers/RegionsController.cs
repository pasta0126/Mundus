...
{
    /// <summary>
    /// Returns the dash-visible region-boundary points within a window,
    /// mirroring <see cref="MapsController"/>'s seed/window/step contract.
    /// </summary>
    [HttpGet]
    public ActionResult<RegionBoundaries> Get(
        ...
        [FromQuery] int? step)
    {
        ...
        return Ok(RegionGenerator.GenerateBoundaries(seed, x.Value, y.Value, width.Value, height.Value, effectiveStep));
    }
}
